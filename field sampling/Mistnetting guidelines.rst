...
C) Site Selection
-----------------
Selecting an appropriate site to trap the target species is very crucial in order to maximize the efficiency given the time constraint in most cases. For trapping the understorey bird species, a mist-net should have understory vegetation fairly thick on both the sides of the net. A small survey of the plot on a previous day may help to locate the sites with regular bird movement between bushes. Vegetation should not be too close to the net, hence a small amount of vegetation thinning may be required. Please note that cutting should not be too much to create a disturbance that birds would notice and hamper their activity. Vegetation with flowering or fruiting plants would assure more captures. Ideally, the site should be selected and prepared on the previous evening and nets should be placed in the same evening. This ensures less disturbance to the birds and assures more captures the next morning when the nets are opened.

D) Setting up Mist-nets
-----------------------
Following the previous point, mist-nets should ideally be placed on the previous evening of the session. The mist-nets have 5 pockets which are marked by 5 loops on either side. The white coloured loop generally marks one end and should be kept at the top or below. Twisting of the net often happen and should be resolved before placing the loops on the poles. The ropes should be tied with a simple knot with an acute angle pointing in the direction of the net placement. A snare like knot is generally helpful. The researcher should make sure that the net is tightly stretched at all the pockets but not too tight.  Most of the field assistants are well trained in placing the nets, yet supervision by the researcher is necessary. After placing the nets, the nets should be closed and the hanging loops should be rolled over. The leading researcher should make sure all the nets are closed before leaving the site that evening.

E) Opening and monitoring nets
------------------------------
Nets should be opened at the crack of dawn just before the start of the birds’ activity (marked by the dawn chorus). Forked sticks can be used to stretch the top loops. The nets should be visited ideally every 15-20 min. The researcher should check all the pockets properly as some times smaller birds trapped in the lowermost pocket go unnoticed. The nets should not be visited too frequently (every 5min or so) otherwise, birds in the vicinity get disturbed and capture rate goes down. On the other hand, keeping too long interval can be threatening to the birds trapped as predators tend to attack the net. An alarm of every 15 or 20min on phone would be best. The researchers should make sure that the field assistants are checking all the nets regularly. Playbacks can be used for target capture. Although playback should not be done continuously for more than 5 min. The most important is to keep the count of active nets every time.

F) Removing the trapped bird from the net
-----------------------------------------
When a bird is trapped, the researcher should approach the net very carefully calmly. Rushing towards the net may startle the trapped making it struggle more and get poorly entangled. The researcher should first determine the side from which the bird is trapped in the net pocket. This is most easily determined by looking at the side form which free legs and belly are seen. The wings and legs are most commonly entangled in the net. The net can be removed layer by layer slowly. The researcher first can free the legs and hold them so that the bird can be manoeuvred if needed. Net threads go around the shoulder when the wing is stuck. The thread can be located by opening the wing carefully and can be removed over the shoulder slowly. Sometimes, the net thread gets entangled in the tongue notch of the bird. In this case, the beak has to be opened slowly and the thread can be pushed inside first to remove from the notch and then removed out. The leading researcher should always monitor the newly learning intern/research and may have to interfere if the entanglement is very complicated. Again the field assistants are generally well trained in removing the bird from the net, but they should be regularly monitored and make sure that they don’t take things lightly. The bird once removed from the net should be immediately put into the bird bag. The researcher should always carry 3-4 bird bags while visiting the net. Carrying a bird in hand toward the processing station should be avoided. If multiple birds are captured at a time, the bird bags should be hanged at around 1m height to a substrate (a long stick or something) from where it must not fall down when the bird moves inside.
